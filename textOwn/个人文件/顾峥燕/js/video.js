 ...
 * @Last Modified time: 2016-11-24 11:35:30
 */
...
(function() {
    ...
    control[3].setAttribute('index','yes');
    //--------------------------------------------------------------------------------监听事件，当前是否为全屏
    ...
    function fnStart() {
        if (vd.paused) { //判断视频是否暂停，如果暂停就播放，否则就暂停；
            ...
            this.children[0].style.marginLeft = ".07rem";
            ...
            this.children[0].style.backgroundSize = '100%';
            this.children[0].style.marginLeft = ".078125rem";
            clearInterval(timer);
        }
    }
    ...
    function fnFull() {
        ...
        if (isFull) {
            ...
            vd.style.height = '6.875rem';
            vd.parentNode.style.height = '6.875rem';
        } else {
            ...
            vd.style.height  = '5.875rem';
            vd.parentNode.style.height = '5.875rem';
        }
        isFull = !isFull;
    }
    function fnKeyDown() {
