(function(){
	...
	DeleEle.prototype = {
		...
		up: function (ev,fnMove,fnUp) {
			...
			this.settings.hint.style.display = 'none';
	...
	var dustbin = document.getElementsByClassName('dustbin')[0];
	...
	deleEmail.init({
		...
		checkBtns: tools.$('.emailListUl input'),
		lis: tools.$('.emailListUl li'),
		fnMove: fnMove,
		fnUp: fnUp,
		hint: Hint
	});
